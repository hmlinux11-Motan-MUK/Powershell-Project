...
$appID = "a88375e8-7d6c-4478-88db-327c31c476df"                 # This is your Entra App ID
$thumbprint = "68E172A225CE7784A888E4741516C8565C6793FD"        # This is certificate thumbprint
$tenant = "a1b70a0b-a9f5-43a5-8d86-f0ecb1208eb0"                # This is your Tenant ID

# --- Input File Path ---
$inputFilePath = 'M:\PSproject\Testing.txt' # Path to the input file containing site URLs
...
$logFilePath = "c:\TEMP\mpd\All_Item_Permissions_$startime.txt"
$outputFilePath = "c:\TEMP\mpd\All_Item_Permissions_$startime.xlsx"
